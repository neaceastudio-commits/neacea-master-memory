...
Infrastruttura indipendente per una memoria personale persistente, versionata e interrogabile. V0.1 usa un progetto Supabase dedicato e non contiene alcun dato personale importato.
...
Le migration sono la fonte di verità dello schema. Non inserire nel repository password, service-role key, token o URL con credenziali. Per il comportamento operativo leggere [MEMORY_PROTOCOL.md](MEMORY_PROTOCOL.md) e [BACKUP_E_RIPRISTINO.md](BACKUP_E_RIPRISTINO.md).
